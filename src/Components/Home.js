...
function Home (props) {
    ...
    return(
        ...
        <div className = "home-container">
            ...
            <p>You might be asking yourself: why would you agree to go on a date if you're just going to sabotage it? If you're asking that question, you must have very little imagination. What if you don't want to hurt nana's feelings by insisting that her nurse just 'isn't your type'? What if you want to see how your date acts under pressure? And what about good, old fashioned revenge?</p>
